...
def is_swap(player_score, opponent_score):
    ...
    if digit_diff(player_score) == digit_diff(opponent_score):
        return True
    return False
    # END PROBLEM 4
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    # BEGIN PROBLEM 5
    "*** YOUR CODE HERE ***"
    def score_change(score_p, score_o ,strategy):    
        score_p += take_turn(strategy(score_p, score_o), score_o, dice)
        if is_swap(score_p, score_o):
            score_p, score_o = score_o, score_p
        return(score_p, score_o)
    while score0 < goal and score1 < goal:
        if player == 0:
            score0, score1 = score_change(score0, score1, strategy0)
        elif player == 1:
            score1, score0 = score_change(score1, score0, strategy1)
        player = other(player)
